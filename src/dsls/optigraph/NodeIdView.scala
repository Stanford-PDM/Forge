...
trait NodeIdViewOps {
  ...
  def importNodeIdViewOps() {
    ...
    NodeIdViewOps {
      ...
      infix ("mapreduce") ( (MInt ==> T,(T,T) ==> T, MInt==>MBoolean) :: T, TNumeric(T), addTpePars=(T)) implements mapReduceZero((MInt,T), 0, ${e => $1(e)}, ${numeric_zero[T]}, ${(a,b) => $2(a,b)}, Some(${c => $3(c)}), "dynamic")
